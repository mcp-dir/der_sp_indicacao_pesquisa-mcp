...
DER SP: Pesquisa de Indicação do Condutor Infrator segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [der_sp_indicacao_pesquisa@mcp.ai](mailto:der_sp_indicacao_pesquisa@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
